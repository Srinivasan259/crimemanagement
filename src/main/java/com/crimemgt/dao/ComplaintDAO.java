...
public class ComplaintDAO {
	...
	public boolean updatemailComplaint(int complaintId) {
		...
		message.setText("Dear " +userName +"\r\n This is the message from cyber crime."
				+ "\r\n Complaint raised by you is solved by the department. Kindly reachout to "+stationName+" - "+stationLoc
				+"\r\n In case of any queries, please call to this number "+stationPhn
				+"\r\n Thank you");
